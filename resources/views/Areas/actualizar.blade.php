          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Actualizar Áreas</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
              ...
              <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                          <form action="{{url(isset($area_edit)?'/Areas/'.$area_edit->id:'Areas')}}" method="POST">
                            @csrf
                            @if (isset($area_edit))
                                @method('PUT')
                            @endif
                            <div class="form-row">
                                <div class="col-sm-12">
                                    <div class="input-group mb-3">
                                        <input minlength="5" maxlength="25" id="area_new" type="text" class="form-control @error('area_new') is-invalid @enderror" name="area_new" value="{{ isset($area_edit)?$area_edit->area_new:old('area_new') }}" required autocomplete="area_new" autofocus
                                         placeholder="Actualizar Área" aria-label="Actualizar Área" aria-describedby="basic-addon2">
